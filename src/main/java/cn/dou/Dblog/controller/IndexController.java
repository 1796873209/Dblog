...
import cn.dou.Dblog.model.*;

import cn.dou.Dblog.service.ArticleService;
import cn.dou.Dblog.service.JedisService;
import cn.dou.Dblog.service.TagService;
import cn.dou.Dblog.service.UserService;
import cn.dou.Dblog.util.JblogUtil;
...
public class IndexController {
    ...
    public String login(Model model, HttpServletResponse httpResponse,
                        @RequestParam(value = "username",required = false) String username,@RequestParam(value = "password",required =false) String password,@RequestParam(value = "next",required = false)String next){
